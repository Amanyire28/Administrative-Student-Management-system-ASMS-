    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                <!-- Search -->
                <form method="GET" action="{{ route('system.users') }}" class="flex">
                    <input type="text"
                           name="search"
                           placeholder="Search..."
                           value="{{ request('search') }}"
                           class="w-48 px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-l-md dark:bg-gray-700 dark:text-gray-300 focus:outline-none focus:ring-1 focus:ring-maroon focus:border-transparent">
                    <button type="submit"
                            class="px-3 py-2 bg-maroon text-white rounded-r-md hover:bg-maroon-dark focus:outline-none focus:ring-1 focus:ring-maroon text-sm">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <span class="text-gray-600 dark:text-gray-400">
                            <span class="inline-flex items-center">
                                ...
                                {{ $users->where('is_active', false)->count() }} inactive
                            </span>
                        </span>
                    </div>
                </div>
