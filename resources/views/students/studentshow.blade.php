...
<body>
  ...
  <form class="g-2" method="GET" action="search.php">
        <div class="input-group">
            <input type="text" class="form-control" placeholder="Search by name, class, or house" aria-label="Recipient's username with two button addons">
  ...
  <a href="studentreg" class="btn btn-warning ms-4 mt-2">Add new Student</a>
  <thead>
    <tr>
      ...
      <td>
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              <li><a href="singlestudent" class="dropdown-item">View</a></li>
              <li><a href="editstudent" class="dropdown-item ">Edit</a></li>
