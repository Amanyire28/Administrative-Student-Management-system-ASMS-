  ...
  <div class="card-body ">
   <form action="" class="">
        ...
        <div class="input-group mb-3">
            ...
            <input class="form-control" type="file" id="formFile"><br>
            <label for="formFile" class="form-label">Add Subject List</label>
            <input class="form-control" type="file" id="formFile">

            <button class="btn btn-outline-success m-2">Add Class Details</button>
    </form>
    <a href="classshow" class="btn btn-outline-secondary m-2">View Classes</a>
  </div>
