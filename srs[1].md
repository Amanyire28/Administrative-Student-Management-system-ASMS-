...
<<<<<<< HEAD
The project will initially focus on the **front-end design** using **tailwind and minimal **custom CSS**, followed by **back-end integration** with PHP and MySQL in a later phase.
=======
...
<<<<<<< HEAD
- **Teachers** – record student marks, manage classes, and view reports.  
- **Headteacher** – handle student registration and record maintenance. 
- **developer** 
=======
...
|------------|--------------|
<<<<<<< HEAD
| **Front-End** | HTML5, tailwind, Vanilla JavaScript (no jQuery), minimal custom CSS |,SPA routing
| **Back-End (to be added)** | PHP, MySQL |
| **Web Server** | XAMPP or live server |
=======
...
|-------|--------|-------------|
<<<<<<< HEAD
| **Phase 1** | Front-End (tauilwind) | UI/UX, Dashboard, Student Management, Reports |
=======
...
<<<<<<< HEAD
**Development Approach:** Front-End First (Tailwind + minimal CSS)
=======
